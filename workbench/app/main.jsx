...
// 右栏 = 标注工作台（decisions 2026-08-14 左右分工）：独立挂载点 #wbann-side，
// 与左栏共享同一个 zustand store（模块级单例，跨 root 生效）。
createRoot(document.getElementById('wbann-side')).render(h(AnnPanel));
