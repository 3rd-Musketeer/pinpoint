 ...
 *  白面 + --wb-line 发丝边 + sh-2 克制阴影 + r-4 圆角 + --wb-font 字栈；序号 chip 从
 *  蓝色 palette 改琥珀（与 .ann-badge / ann-list.css 的 .wb-ann-num 同族）。
...
export function bubbleCss() {
  return [
    ...
    'border:1px solid var(--wb-line,rgba(0,0,0,.07));border-radius:var(--wb-r-4,12px);',
    ...
    'background:var(--wb-side,#f6f6f7);border-bottom:1px solid var(--wb-line,rgba(0,0,0,.07));}',
