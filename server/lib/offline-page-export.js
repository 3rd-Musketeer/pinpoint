...
export function buildOfflineShareHtml(options) {
  ...
  const shareCss = `
html,body{margin:0;min-height:100%;background:var(--wb-stage-bg,#faf8f4);color:var(--wb-fg,#1c2024);font-family:var(--wb-font,-apple-system,BlinkMacSystemFont,"SF Pro Text","PingFang SC",system-ui,sans-serif)}
