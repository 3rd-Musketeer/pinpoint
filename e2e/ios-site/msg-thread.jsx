export default function MsgThread() {
  return (
    <>
    <div class="ios-app" style="display:flex;flex-direction:column;overflow:hidden">
      ...
      <div class="ios-page" style="flex:1;min-height:0;overflow-y:auto;display:flex;flex-direction:column;gap:10px;padding-bottom:12px">
        ...
        <div class="ios-muted ios-footnote" style="text-align:center;padding:4px 0">已读</div>
      </div>
      <div style="flex:none;display:flex;align-items:flex-end;gap:8px;padding:8px 12px calc(10px + var(--ios-safe-bottom));border-top:0.5px solid var(--ios-sep);background:var(--ios-bg-2)">
        ...
        <div style="flex:1;min-width:0;min-height:34px;border-radius:18px;background:var(--ios-fill-3);padding:8px 14px;color:var(--ios-text-2);font-size:var(--ios-t-body);line-height:1.3">iMessage</div>
