...
/**
 * 模板页（Example Library / Example HTML；pp2 切片 2 前还有 Component Library）
 * 2026-09-04 起默认不显示（ADR 0032，开关在预览设置）。要在这些页上断言的 spec
 * 进 workbench 之前先把开关打开——init script 在页面脚本之前跑，合并写进同一份
 * prefs，不动其它偏好。
 */
